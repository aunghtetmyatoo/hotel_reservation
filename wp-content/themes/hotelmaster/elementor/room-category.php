<?php	
	...
	add_action( 'elementor/widgets/widgets_registered', 'hotelmaster_register_elementor_room_category_widget' );
	function hotelmaster_register_elementor_room_category_widget(){
		if( !function_exists('gdlr_print_room_category_item') ) return;

		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Hotelmaster_Elementor_Room_Category_Widget() );
	}

	class Hotelmaster_Elementor_Room_Category_Widget extends \Elementor\Widget_Base {

		public function get_name() {
			return 'hotel-room-category';
		}

		public function get_title() {
			return __( 'Hotel Room Category', 'gdlr_translate' );
		}
